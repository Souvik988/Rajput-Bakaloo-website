...
class _CartAddressHeaderState extends State<CartAddressHeader> {
  ...
  Future<String?> _resolveDistanceLabel() async {
    try {
      ...
      // Tiered cached/low/medium-accuracy fallback (resilient_location.dart)
      // instead of a bare getCurrentPosition() with no timeLimit, which
      // could hang indefinitely on a cold GPS fix and leave this badge
      // stuck on the "Near you" placeholder forever.
