...
abstract class ApiClient {
  ...
  /// Every active PROFILE_MENU nav button for this viewer (Business
  /// Transaction, Games, and any others configured in the dashboard) —
  /// unlike getNavButton() above (the single 5th bottom-nav slot), this
  /// can return several at once.
  @GET(ApiConstants.navButtonProfileMenu)
  Future<ApiResponse<dynamic>> getNavButtonProfileMenu();
